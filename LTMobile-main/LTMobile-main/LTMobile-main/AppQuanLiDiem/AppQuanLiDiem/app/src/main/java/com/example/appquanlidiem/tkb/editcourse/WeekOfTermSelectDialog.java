package com.example.appquanlidiem.tkb.editcourse;
...
public class WeekOfTermSelectDialog extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_selectweek_tkb);
        init();
        RecyclerView recyclerView = findViewById(R.id.mp_rv_week_of_term);
        GridLayoutManager gridLayoutManager =
                new GridLayoutManager(mContext, 5);
        recyclerView.setLayoutManager(gridLayoutManager);
        dialogAdapter = new DialogAdapter(list);
        recyclerView.setAdapter(dialogAdapter);
        selectAll = findViewById(R.id.mp_check_box_select_all);
        ...
        singleWeek = findViewById(R.id.mp_check_box_single_week);
        ...
        doubleWeek = findViewById(R.id.mp_check_box_double_week);
        ...
        Button cancelBtn = findViewById(R.id.mp_btn_cancel);
        Button yesBtn = findViewById(R.id.mp_btn_yes);
    ...
    private static class DialogAdapter extends RecyclerView.Adapter<DialogAdapter.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.week_checkbox_tkb, parent, false);
        ...
        private static class ViewHolder extends RecyclerView.ViewHolder {
            ...
            public ViewHolder(View view) {
                super(view);
                checkBox = view.findViewById(R.id.mp_checkBox);
            }
        }
    }
}
