package com.example.appquanlidiem.ui_tkb.settime;
...
public class SetTimeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_set_time_tkb);
        setActionBar();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_set_time_tkb, menu);
    ...
    private class TimeAdapter extends RecyclerView.Adapter<TimeAdapter.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_time_tkb, parent, false);
